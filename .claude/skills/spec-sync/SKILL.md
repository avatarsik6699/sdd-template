...
Execute the canonical playbook in [docs/workflows/spec-sync.md](../../../docs/workflows/spec-sync.md). That file is the source of truth for all steps, the impact-analysis matrix, the CHANGELOG entry format, and the rules.
