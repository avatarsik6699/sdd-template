...
Execute the canonical playbook in [docs/workflows/context-update.md](../../../docs/workflows/context-update.md). That file is the source of truth for all steps, the version-bump rules, and the final report format.
