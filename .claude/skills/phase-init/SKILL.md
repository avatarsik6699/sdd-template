...
Execute the canonical playbook in [docs/workflows/phase-init.md](../../../docs/workflows/phase-init.md). That file is the source of truth for all steps, inputs, rules, and the final report format.
