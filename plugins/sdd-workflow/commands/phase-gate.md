...
Execute the canonical playbook: [docs/workflows/phase-gate.md](../../../docs/workflows/phase-gate.md). Stack-specific commands live in [docs/STACK.md → Gate Commands](../../../docs/STACK.md#gate-commands).
