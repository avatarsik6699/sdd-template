...
Execute the canonical playbook in [workflow/docs/playbooks/spec-init.md](../../../../workflow/docs/playbooks/spec-init.md). That file is the source of truth for drafting steps, critical validation checks, and clarification-loop rules.
