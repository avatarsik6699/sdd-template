...
Execute the canonical playbook in [workflow/docs/playbooks/context-update.md](../../../workflow/docs/playbooks/context-update.md). That file is the source of truth for all steps, the version-bump rules, and the final report format.
