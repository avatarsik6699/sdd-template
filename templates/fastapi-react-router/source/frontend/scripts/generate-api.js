...
const downloadSchema = async () => {
  ...
  try {
    ...
    fs.writeFileSync(safePath, JSON.stringify(schema, null, 2), { encoding: 'utf8', mode: 0o644 });
...
const generateTypes = () => {
  ...
  try {
    execSync(`npx openapi-typescript ${SCHEMA_PATH} -o ${OUTPUT_TYPES_PATH}`, { stdio: 'inherit' });
