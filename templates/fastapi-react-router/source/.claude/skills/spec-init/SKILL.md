...
Execute the canonical playbook in [workflow/docs/playbooks/spec-init.md](../../../workflow/docs/playbooks/spec-init.md). That file is the source of truth for steps, validation checks, clarification loop rules, and final report format.
