...
Execute the canonical playbook in [workflow/docs/playbooks/spec-sync.md](../../../workflow/docs/playbooks/spec-sync.md). That file is the source of truth for all steps, the impact-analysis matrix, the CHANGELOG entry format, and the rules.
